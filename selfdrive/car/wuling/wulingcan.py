...
def create_buttons(packer, idx, button):
  ...
  print(values)
  # commands.append(packer.make_can_msg("STEER_BTN",  2, values))
...
def create_radar_command(packer, cmd_stock, cmd, enable, frame, CC, CS):
  accel = 0
  ret = []  
  ...
  if enable:
      values.update({
        "ACC_STATE": cmd["ACC_STATE"],
        "GAS_CMD": cmd["GAS_CMD"],
        "NEW_SIGNAL_1": cmd["NEW_SIGNAL_1"],
        "NEW_SIGNAL_2": cmd["NEW_SIGNAL_2"],
        "NEW_SIGNAL_3": cmd["NEW_SIGNAL_3"],
        "NEW_SIGNAL_4": cmd["NEW_SIGNAL_4"],
        "NEW_SIGNAL_5": cmd["NEW_SIGNAL_5"],
        "NEW_SIGNAL_9": cmd["NEW_SIGNAL_9"],
        "NEW_SIGNAL_11": cmd["NEW_SIGNAL_11"],
        "STOP_REQUEST": cmd["STOP_REQUEST"],
        "STOPPING_T1": cmd["STOPPING_T1"],
        "FULL_STOP": cmd["FULL_STOP"],
        "FULL_STOP_INV": cmd["FULL_STOP_INV"],
      })
