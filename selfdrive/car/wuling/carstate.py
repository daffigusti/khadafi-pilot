...
from openpilot.selfdrive.car.wuling.values import DBC, AccState, CanBus, CAR, PREGLOBAL_CARS,CarControllerParams
...
class CarState(CarStateBase):
  ...
  def update(self, pt_cp, cam_cp, loopback_cp):
    ...
    if self.CP.enableBsm:
      ret.leftBlindspot = bool(cam_cp.vl["BSM_SIGNAL"]["SIGNAL_1"])
      ret.rightBlindspot = bool(cam_cp.vl["BSM_SIGNAL"]["SIGNAL_2"])
